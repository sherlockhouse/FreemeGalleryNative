...
public class AlbumSetSlidingWindow implements AlbumSetDataLoader.DataListener {
    ...
    public AlbumSetSlidingWindow(AbstractGalleryActivity activity,
        ...
        mLoadingText = activity.getAndroidContext().getString(com.freeme.gallery.R.string.loading);
    ...
    //*/ Added by Linguanrong for story album, 2015-4-8
    public int getCount(int index) {
        return mSource.getTotalCount(index);
    }
