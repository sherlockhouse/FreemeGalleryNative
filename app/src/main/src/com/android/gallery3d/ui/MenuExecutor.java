...
public class MenuExecutor {
    ...
    private static boolean                 mHasCancelMultiOperation;
    private static ProgressDialog createProgressDialog(
        ...
        //*/ Added by droi Linguanrong for cancel func, 16-4-11
        dialog.setButton(AlertDialog.BUTTON_NEGATIVE, context.getString(R.string.cancel), new OnClickListener() {
            @Override
    ...
    public static void updateMenuOperation(Menu menu, int supported) {
        ...
        boolean supportComment = (supported & MediaObject.SUPPORT_COMMENT) != 0;
        //*/
        ...
        //*/ Added by droi Linguanrong for comments, 16-2-1
        setMenuItemVisible(menu, R.id.action_comment, supportComment);
        //*/
    }
...
//        setMenuItemVisible(menu, R.id.action_setcover, supported);
    ...
    public static void updateMenuCrop(Menu menu, boolean supported) {
        setMenuItemVisible(menu, R.id.action_crop, supported);
    }
    ...
    public static void updateMenuDelete(Menu menu, boolean supported) {
        setMenuItemVisible(menu, R.id.action_delete, supported);
    }
    ...
    private class ConfirmDialogListener implements OnClickListener, OnCancelListener {
        ...
        public void onClick(DialogInterface dialog, int which) {
            if (which == DialogInterface.BUTTON_POSITIVE) {
                ...
                if (mSelectionManager.getSelectedCount() > 5) {
                    onMenuClicked(mActionId, mListener);
                } else {
                    onMenuClicked(mActionId, mListener, false, false);
